...
# Database: kumu
# Generation Time: 2021-01-17 07:08:56 +0000
# ************************************************************
...
CREATE TABLE `guests` (
  ...
  `address` varchar(120) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `guests` (`id`, `firstname`, `lastname`, `email`, `number`, `gender`, `address`)
VALUES
	(1,'First Guest Firstname User','First Guest Lastname User','firstguest@email.com','','Male','First guest address'),
	(2,'Secot Guest Firstname User','Secot Guest Lastname User','secondguest@email.com','1234123','Female','Secod guest address'),
	(3,'Third Guest Firstname User','Third Guest Lastname User','thirdguest@email.com','456789','Male','Third guest address'),
	(4,'Third Guest Firstname User','Third Guest Lastname User','fourthguest@email.com','1234789','Female','Fourth guest address'),
	(5,'Test 1','Test 2 Lastname','dummy1@email.com','789456','Femail','Test Address'),
	(6,'Test 2','Test 2 Lastname','dummy2@email.com','1234123','pijqwepor','Test Address'),
	(7,'Test 3','Test 2 Lastname','dummy3@email.com','1234123','pijqwepor','Test Address'),
	(8,'Test 4','Test 2 Lastname','dummy4@email.com','1234123','pijqwepor','Test Address'),
	(9,'Test 5','Test 2 Lastname','dummy5@email.com','1234123','qwerqwer','Test Address');
